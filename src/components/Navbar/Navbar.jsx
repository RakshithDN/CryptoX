  ...
  return (
    <Typography as="li" variant="small" className="p-1 font-medium text-white">
      <Link
        ...
        smooth={true}
        duration={500}
        className={`flex items-center transition-colors cursor-pointer hover:scale-105 ${activeSection === to ? "text-blue-400" : "hover:text-blue-400"
          }`}
      >
        {children}
      </Link>
...
export const NavbarSimple = () => {
  ...
  return (
    <Navbar
      className={`h-max max-w-full px-6 py-3 fixed z-50 rounded-none border-none transition-all duration-300 ${scrolled || openNav
